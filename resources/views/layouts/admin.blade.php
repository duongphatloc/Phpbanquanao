                        ...
                        <div class="dropdown-menu-header">
                          <div class="dropdown-menu-header-inner bg-info">
                            <div
                              ...
                              style="
                                background-image: url('dashboard/assets/images/dropdown-header/city3.jpg');
                              "
                            ></div>
              ...
              <ul class="vertical-nav-menu">
                ...
                <li class="mm-active">
                  ...
                  <ul>
                    ...
                    <li>
                      <a href="{{ route('dashboard.catarogy.index')}}">
                        <i class="metismenu-icon"></i>Catarogy
                      </a>
                    </li>
                    <li>
                      <a href="{{ route('dashboard.image.index')}}">
                        <i class="metismenu-icon"></i>Image
                      </a>
                    </li>
                        ...
                        <div class="dropdown-menu-header mb-0">
                          <div class="dropdown-menu-header-inner bg-deep-blue">
                            <div
                              ...
                              style="
                                background-image: url('dashboard//images/dropdown-header/city3.jpg');
                              "
                            ></div>
                                              ...
                                              >
                                                ...
                                                >
                                                  <div class="avatar-icon">
                                                    <img
                                                      src="dashboard//images/avatars/1.jpg"
                                                      alt=""
                                                    />
                                                  </div>
                                                </div>
                                                ...
                                                >
                                                  <div class="avatar-icon">
                                                    <img
                                                      src="dashboard//images/avatars/2.jpg"
                                                      alt=""
                                                    />
                                                  </div>
                                                </div>
                                                ...
                                                >
                                                  <div class="avatar-icon">
                                                    <img
                                                      src="dashboard//images/avatars/3.jpg"
                                                      alt=""
                                                    />
                                                  </div>
                                                </div>
                                                ...
                                                >
                                                  <div class="avatar-icon">
                                                    <img
                                                      src="dashboard//images/avatars/4.jpg"
                                                      alt=""
                                                    />
                                                  </div>
                                                </div>
                                                ...
                                                >
                                                  <div class="avatar-icon">
                                                    <img
                                                      src="dashboard//images/avatars/5.jpg"
                                                      alt=""
                                                    />
                                                  </div>
                                                </div>
                                                ...
                                                >
                                                  <div class="avatar-icon">
                                                    <img
                                                      src="dashboard//images/avatars/9.jpg"
                                                      alt=""
                                                    />
                                                  </div>
                                                </div>
                                                ...
                                                >
                                                  <div class="avatar-icon">
                                                    <img
                                                      src="dashboard//images/avatars/7.jpg"
                                                      alt=""
                                                    />
                                                  </div>
                                                </div>
                                                ...
                                                >
                                                  <div class="avatar-icon">
                                                    <img
                                                      src="dashboard//images/avatars/8.jpg"
                                                      alt=""
                                                    />
                                                  </div>
                                                </div>
                        ...
                        <div class="dropdown-menu-header">
                          ...
                          >
                            <div
                              ...
                              style="
                                background-image: url('dashboard//images/dropdown-header/city2.jpg');
                              "
                            ></div>
                            <div
                        ...
                        <div class="dropdown-menu-header">
                          ...
                          >
                            <div
                              ...
                              style="
                                background-image: url('dashboard//images/dropdown-header/abstract4.jpg');
                              "
                            ></div>
                          ...
                          <div class="dropdown-menu-header">
                            ...
                            >
                              <div
                                class="menu-header-image opacity-1"
                                style="
                                  background-image: url('dashboard//images/dropdown-header/city5.jpg');
                                "
                              ></div>
                              <div class="menu-header-content text-dark">
                      ...
                      <h4 class="timeline-title">
                        ...
                        <div class="avatar-wrapper mt-2 avatar-wrapper-overlap">
                          <div class="avatar-icon-wrapper avatar-icon-sm">
                            <div class="avatar-icon">
                              <img src="dashboard//images/avatars/1.jpg" alt="" />
                            </div>
                          </div>
                          <div class="avatar-icon-wrapper avatar-icon-sm">
                            <div class="avatar-icon">
                              <img src="dashboard//images/avatars/2.jpg" alt="" />
                            </div>
                          </div>
                          <div class="avatar-icon-wrapper avatar-icon-sm">
                            <div class="avatar-icon">
                              <img src="dashboard//images/avatars/3.jpg" alt="" />
                            </div>
                          </div>
                          <div class="avatar-icon-wrapper avatar-icon-sm">
                            <div class="avatar-icon">
                              <img src="dashboard//images/avatars/4.jpg" alt="" />
                            </div>
                          </div>
                          <div class="avatar-icon-wrapper avatar-icon-sm">
                            <div class="avatar-icon">
                              <img src="dashboard//images/avatars/5.jpg" alt="" />
                            </div>
                          </div>
                          <div class="avatar-icon-wrapper avatar-icon-sm">
                            <div class="avatar-icon">
                              <img src="dashboard//images/avatars/6.jpg" alt="" />
                            </div>
                          </div>
                          <div class="avatar-icon-wrapper avatar-icon-sm">
                            <div class="avatar-icon">
                              <img src="dashboard//images/avatars/7.jpg" alt="" />
                            </div>
                          </div>
                          <div class="avatar-icon-wrapper avatar-icon-sm">
                            <div class="avatar-icon">
                              <img src="dashboard//images/avatars/8.jpg" alt="" />
                            </div>
                          </div>
                          <div
                            class="avatar-icon-wrapper avatar-icon-sm avatar-icon-add"
